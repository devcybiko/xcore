...
public class ClassFinder {
	 ...
	 */
	public final void refreshLocations(String classpath) {
		synchronized (classpathLocations) {
			classpathLocations = getClasspathLocations(classpath);
		}
	}
	 ...
	 */
	public final Map<URL, String> getClasspathLocations(String classpath) {
...
//					if (BSFEngine.class.isAssignableFrom(clazz)
//							&& !clazz.equals(BSFEngine.class)) {
